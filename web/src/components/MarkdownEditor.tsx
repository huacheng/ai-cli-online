...
const SLASH_COMMANDS = [
  ...
  // moonview — task lifecycle
  { cmd: '/moonview:ai-cli-task', desc: 'Task lifecycle management (13 skills)' },
  { cmd: '/moonview:init', desc: 'Initialize task module + branch' },
  { cmd: '/moonview:plan', desc: 'Generate implementation plan' },
  { cmd: '/moonview:research', desc: 'Collect external references' },
  { cmd: '/moonview:check', desc: 'Check feasibility (post-plan/mid/post-exec)' },
  { cmd: '/moonview:verify', desc: 'Run domain-adapted tests' },
  { cmd: '/moonview:exec', desc: 'Execute implementation plan' },
  { cmd: '/moonview:merge', desc: 'Merge task branch to main' },
  { cmd: '/moonview:report', desc: 'Generate completion report' },
  { cmd: '/moonview:auto', desc: 'Autonomous full lifecycle loop' },
  { cmd: '/moonview:cancel', desc: 'Cancel task + optional cleanup' },
  { cmd: '/moonview:list', desc: 'Query task status (read-only)' },
  { cmd: '/moonview:annotate', desc: 'Process Plan panel annotations' },
  { cmd: '/moonview:summarize', desc: 'Regenerate context summary' },
];
